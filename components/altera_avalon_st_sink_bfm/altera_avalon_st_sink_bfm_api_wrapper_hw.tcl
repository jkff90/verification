...
# $Id: //acds/rel/13.1/ip/sopc/components/verification/altera_avalon_st_sink_bfm/altera_avalon_st_sink_bfm_api_wrapper_hw.tcl#1 $
# $Revision: #1 $
# $Date: 2013/08/11 $
# $Author: swbranch $
#------------------------------------------------------------------------------
...
set_module_property DESCRIPTION                    "Altera Avalon ST Sink BFM with Avalon ST API Wrapper"
set_module_property NAME                           altera_avalon_st_sink_bfm_api_wrapper
set_module_property VERSION                        13.1
set_module_property AUTHOR                         "Altera Corporation"
set_module_property GROUP                          "Avalon Verification Suite"
set_module_property DISPLAY_NAME                   "Altera Avalon ST Sink BFM with Avalon ST API Wrapper"
set_module_property TOP_LEVEL_HDL_FILE             altera_avalon_st_sink_bfm_api_wrapper.sv
set_module_property TOP_LEVEL_HDL_MODULE           altera_avalon_st_sink_bfm_api_wrapper
...
proc sim_ver {name} {
   ...
   add_fileset_file altera_avalon_st_sink_bfm_api_wrapper.sv SYSTEM_VERILOG PATH "altera_avalon_st_sink_bfm_api_wrapper.sv" 
}
...
proc sim_vhd {name} {
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_avalon_st_sink_bfm_api_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_st_sink_bfm_api_wrapper.sv" {MENTOR_SPECIFIC}
   }
   ...
   add_fileset_file altera_avalon_st_sink_bfm_api_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_st_sink_bfm_api_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
...
proc elaborate { } {
    ...
    add_interface $AV_CLOCK_INTERFACE clock sink
    ...
    set_interface_property $SINK_INTERFACE ASSOCIATED_CLOCK $AV_CLOCK_INTERFACE
    ...
    add_interface_port $SINK_INTERFACE sink_data data Input $ST_DATA_W_VALUE
    set_port_property sink_data VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $SINK_INTERFACE sink_valid valid Input 1
    add_interface_port $SINK_INTERFACE sink_ready ready Output 1
    add_interface_port $SINK_INTERFACE sink_startofpacket startofpacket Input 1
    add_interface_port $SINK_INTERFACE sink_endofpacket endofpacket Input 1
    add_interface_port $SINK_INTERFACE sink_empty empty Input $ST_EMPTY_W_VALUE
    set_port_property sink_empty VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $SINK_INTERFACE sink_channel channel Input $ST_CHANNEL_W_VALUE
    set_port_property sink_channel VHDL_TYPE STD_LOGIC_VECTOR
    add_interface_port $SINK_INTERFACE sink_error error Input $ST_ERROR_W_VALUE

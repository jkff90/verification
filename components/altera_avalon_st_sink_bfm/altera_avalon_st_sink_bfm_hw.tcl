...
# $Id: //acds/rel/13.1/ip/sopc/components/verification/altera_avalon_st_sink_bfm/altera_avalon_st_sink_bfm_hw.tcl#2 $
# $Revision: #2 $
# $Date: 2013/08/15 $
# $Author: saafnan $
#------------------------------------------------------------------------------
...
set_module_property DESCRIPTION         	       "Altera Avalon-ST Sink BFM"
set_module_property NAME                	       altera_avalon_st_sink_bfm
set_module_property VERSION             	       13.1
set_module_property AUTHOR           	 	       "Altera Corporation"
set_module_property GROUP               	       "Avalon Verification Suite"
set_module_property DISPLAY_NAME        	       "Altera Avalon-ST Sink BFM"
...
set_fileset_property quartus_synth top_level altera_avalon_st_sink_bfm

add_fileset sim_verilog SIM_VERILOG sim_verilog
set_fileset_property sim_verilog top_level altera_avalon_st_sink_bfm

add_fileset sim_vhdl SIM_VHDL sim_vhdl
set_fileset_property sim_vhdl top_level altera_avalon_st_sink_bfm_vhdl

# SIM_VERILOG generation callback procedure
proc sim_verilog {altera_avalon_st_sink_bfm} {
   set HDL_LIB_DIR "../lib"
   ...
   add_fileset_file altera_avalon_st_sink_bfm.sv SYSTEM_VERILOG PATH "altera_avalon_st_sink_bfm.sv" 
...
proc quartus_synth_proc {altera_avalon_st_sink_bfm} {
   set HDL_LIB_DIR "../lib"
   add_fileset_file verbosity_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/verbosity_pkg.sv" 
   add_fileset_file avalon_utilities_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/avalon_utilities_pkg.sv" 
   add_fileset_file altera_avalon_st_sink_bfm.sv SYSTEM_VERILOG PATH "altera_avalon_st_sink_bfm.sv" 
...
proc sim_vhdl {altera_avalon_st_sink_bfm_vhdl} {
   set HDL_LIB_DIR "../lib"
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_avalon_st_sink_bfm.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_st_sink_bfm.sv" {MENTOR_SPECIFIC}
      add_fileset_file mentor/altera_avalon_st_sink_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_st_sink_bfm_vhdl_wrapper.sv" {MENTOR_SPECIFIC}
   ...
   add_fileset_file altera_avalon_st_sink_bfm.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_st_sink_bfm.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   add_fileset_file altera_avalon_st_sink_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_st_sink_bfm_vhdl_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   
   set_fileset_file_attribute verbosity_pkg.sv           COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_verbosity_pkg
   set_fileset_file_attribute avalon_utilities_pkg.sv    COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_avalon_utilities_pkg
   
   add_fileset_file altera_avalon_st_sink_bfm_vhdl_pkg.vhd VHDL path "$VHDL_DIR/altera_avalon_st_sink_bfm_vhdl_pkg.vhd"
   add_fileset_file altera_avalon_st_sink_bfm_vhdl.vhd VHDL path "$VHDL_DIR/altera_avalon_st_sink_bfm_vhdl.vhd"
...
set ST_ERROR_DESCRIPTOR "ST_ERROR_DESCRIPTOR"
set VHDL_ID             "VHDL_ID"
...
add_parameter $ST_ERROR_DESCRIPTOR STRING_LIST ""
set_parameter_property $ST_ERROR_DESCRIPTOR DISPLAY_NAME "Error Descriptors"
set_parameter_property $ST_ERROR_DESCRIPTOR DESCRIPTION "Descriptor for Every Bit of Error Signal"
set_parameter_property $ST_ERROR_DESCRIPTOR HDL_PARAMETER false
set_parameter_property $ST_ERROR_DESCRIPTOR VISIBLE false
set_parameter_property $ST_ERROR_DESCRIPTOR GROUP "Error Attributes"
...
proc validate { } {
    ...
    set error_descriptors [get_parameter $ST_ERROR_DESCRIPTOR]
    set error_descriptors_size [llength [split $error_descriptors ","]]
    set error_width [get_parameter $ST_ERROR_W]
    if {$error_descriptors_size > 0} {
      if {$error_descriptors_size != $error_width} {
         send_message error "ST_ERROR_DESCRIPTOR size $error_descriptors_size does not match ST_ERROR_W $error_width."
      }
    }
}
#------------------------------------------------------------------------------
proc elaborate { } {
    ...
    set ST_ERROR_DESCRIPTOR_VALUE   [ get_parameter $ST_ERROR_DESCRIPTOR ] 
    ...
    set_interface_property $SINK_INTERFACE errorDescriptor "$ST_ERROR_DESCRIPTOR_VALUE"
    ...
    set_interface_property $SINK_INTERFACE beatsPerCycle $ST_BEATSPERCYCLE_VALUE
	...
	send_message Info "Use Valid set to zero - omitting sink_valid port"
	set_port_property sink_valid TERMINATION 1
	set_port_property sink_valid TERMINATION_VALUE 1'b1
    }
    if { $USE_READY_VALUE == 0 } {  
	send_message Info "Use Ready set to zero - omitting sink_ready port"
	set_port_property sink_ready TERMINATION 1
    }
    if { $USE_PACKET_VALUE == 0 } {  
	send_message Info "Use Packets set to zero - omitting sink_startofpacket, sink_endofpacket and sink_empty ports"
   ...
   set_parameter_property $USE_EMPTY ENABLED true
	...
	send_message Info "Use Empty set to zero - omitting sink_empty port"
	set_port_property sink_empty TERMINATION 1
	set_port_property sink_empty TERMINATION_VALUE 0
    }
    if { $USE_CHANNEL_VALUE == 0 } { 
	send_message Info "Use Channels set to zero - omitting sink_channel port"
   ...
   set_parameter_property $ST_CHANNEL_W ENABLED true
	...
	send_message Info "Use Error set to zero - omitting sink_error port"

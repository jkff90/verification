...
# $Id: //acds/rel/13.1/ip/sopc/components/verification/altera_avalon_st_source_bfm/altera_avalon_st_source_bfm_hw.tcl#2 $
# $Revision: #2 $
# $Date: 2013/08/15 $
# $Author: saafnan $
#------------------------------------------------------------------------------
...
set_module_property DESCRIPTION    		          "Altera Avalon-ST Source BFM"
set_module_property NAME           		          altera_avalon_st_source_bfm
set_module_property VERSION        		          13.1
set_module_property GROUP          		          "Avalon Verification Suite"
set_module_property AUTHOR           	 	       "Altera Corporation"
set_module_property DISPLAY_NAME                 "Altera Avalon-ST Source BFM"
...
set_fileset_property quartus_synth top_level altera_avalon_st_source_bfm

add_fileset sim_verilog SIM_VERILOG sim_verilog
set_fileset_property sim_verilog top_level altera_avalon_st_source_bfm

add_fileset sim_vhdl SIM_VHDL sim_vhdl
set_fileset_property sim_vhdl top_level altera_avalon_st_source_bfm_vhdl

# SIM_VERILOG generation callback procedure
proc sim_verilog {altera_avalon_st_source_bfm} {
   set HDL_LIB_DIR "../lib"
...
proc quartus_synth_proc {altera_avalon_st_source_bfm} {
   set HDL_LIB_DIR "../lib"
   add_fileset_file verbosity_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/verbosity_pkg.sv" 
   add_fileset_file avalon_utilities_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/avalon_utilities_pkg.sv" 
   add_fileset_file altera_avalon_st_source_bfm.sv SYSTEM_VERILOG PATH "altera_avalon_st_source_bfm.sv" 
...
proc sim_vhdl {altera_avalon_st_source_bfm_vhdl} {
   set HDL_LIB_DIR   "../lib"
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_avalon_st_source_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_st_source_bfm_vhdl_wrapper.sv" {MENTOR_SPECIFIC}
   ...
   add_fileset_file altera_avalon_st_source_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_st_source_bfm_vhdl_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   
   set_fileset_file_attribute verbosity_pkg.sv           COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_verbosity_pkg
   set_fileset_file_attribute avalon_utilities_pkg.sv    COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_avalon_utilities_pkg
   
   add_fileset_file altera_avalon_st_source_bfm_vhdl_pkg.vhd VHDL path "$VHDL_DIR/altera_avalon_st_source_bfm_vhdl_pkg.vhd"
   add_fileset_file altera_avalon_st_source_bfm_vhdl.vhd VHDL path "$VHDL_DIR/altera_avalon_st_source_bfm_vhdl.vhd"
...
proc elaborate {} {
    ...
    set_interface_property $SOURCE_INTERFACE errorDescriptor "$ST_ERROR_DESCRIPTOR_VALUE"

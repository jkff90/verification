...
# $File: //acds/rel/13.1/ip/sopc/components/verification/altera_avalon_mm_master_bfm/altera_avalon_mm_master_bfm_api_wrapper_hw.tcl $
# $Revision: #1 $
# $Date: 2013/08/11 $
# $Author: swbranch $
#------------------------------------------------------------------------------
...
set_module_property NAME                           altera_avalon_mm_master_bfm_api_wrapper
set_module_property DISPLAY_NAME                   "Altera Avalon MM Master BFM with Avalon ST API Wrapper"
set_module_property DESCRIPTION                    "Altera Avalon MM Master BFM with Avalon ST API Wrapper"
set_module_property VERSION                        13.1
set_module_property GROUP                          "Avalon Verification Suite"
set_module_property AUTHOR                         "Altera Corporation"
set_module_property TOP_LEVEL_HDL_FILE             altera_avalon_mm_master_bfm_api_wrapper.sv
set_module_property TOP_LEVEL_HDL_MODULE           altera_avalon_mm_master_bfm_api_wrapper
...
proc sim_ver {name} {
   ...
   add_fileset_file altera_avalon_mm_master_bfm_api_wrapper.sv SYSTEM_VERILOG PATH "altera_avalon_mm_master_bfm_api_wrapper.sv" 
}
...
proc sim_vhd {name} {
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_avalon_mm_master_bfm_api_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_mm_master_bfm_api_wrapper.sv" {MENTOR_SPECIFIC}
   }
   ...
   add_fileset_file altera_avalon_mm_master_bfm_api_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_mm_master_bfm_api_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
}
...
proc elaborate {} {
    ...
    # Interface Names
    #---------------------------------------------------------------------
    set AVM_CLOCK_INTERFACE   "avm_clk"
    set MASTER_INTERFACE      "m0"

    #---------------------------------------------------------------------
    # Avalon Clock-Reset connection point
    #---------------------------------------------------------------------
    add_interface $AVM_CLOCK_INTERFACE clock end
    add_interface_port $AVM_CLOCK_INTERFACE avm_clk clk Input 1
    if {$ASSERT_HIGH_RESET_VALUE > 0 } {
       add_interface_port $AVM_CLOCK_INTERFACE avm_reset reset Input 1
    } else {
       add_interface_port $AVM_CLOCK_INTERFACE avm_reset reset_n Input 1
    }
    ...
    set_interface_property $MASTER_INTERFACE ASSOCIATED_CLOCK $AVM_CLOCK_INTERFACE

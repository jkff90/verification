...
# $File: //acds/rel/13.1/ip/sopc/components/verification/altera_avalon_mm_slave_bfm/altera_avalon_mm_slave_bfm_hw.tcl $
# $Revision: #3 $
# $Date: 2013/08/15 $
# $Author: saafnan $
#------------------------------------------------------------------------------
...
set_module_property NAME                         altera_avalon_mm_slave_bfm
set_module_property GROUP                        "Avalon Verification Suite"
set_module_property DISPLAY_NAME                 "Altera Avalon-MM Slave BFM"
set_module_property DESCRIPTION                  "Altera Avalon-MM Slave BFM"
...
set_fileset_property sim_verilog top_level altera_avalon_mm_slave_bfm

add_fileset sim_vhdl SIM_VHDL sim_vhdl
set_fileset_property sim_vhdl top_level altera_avalon_mm_slave_bfm_vhdl

add_fileset quartus_synth QUARTUS_SYNTH quartus_synth_proc
set_fileset_property quartus_synth top_level altera_avalon_mm_slave_bfm

# SIM_VERILOG generation callback procedure
proc sim_verilog {altera_avalon_mm_slave_bfm} {
   set HDL_LIB_DIR "../lib"
...
proc quartus_synth_proc {altera_avalon_mm_slave_bfm} {
   set HDL_LIB_DIR "../lib"
   add_fileset_file verbosity_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/verbosity_pkg.sv" 
   add_fileset_file avalon_mm_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/avalon_mm_pkg.sv"
   add_fileset_file avalon_utilities_pkg.sv SYSTEM_VERILOG PATH "$HDL_LIB_DIR/avalon_utilities_pkg.sv"
...
proc sim_vhdl {altera_avalon_mm_slave_bfm_vhdl} {
   set HDL_LIB_DIR "../lib"
   ...
   if {1} {
      ...
      add_fileset_file mentor/altera_avalon_mm_slave_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "mentor/altera_avalon_mm_slave_bfm_vhdl_wrapper.sv" {MENTOR_SPECIFIC}
   ...
   add_fileset_file altera_avalon_mm_slave_bfm_vhdl_wrapper.sv SYSTEM_VERILOG_ENCRYPT PATH "altera_avalon_mm_slave_bfm_vhdl_wrapper.sv" {ALDEC_SPECIFIC CADENCE_SPECIFIC SYNOPSYS_SPECIFIC}
   
   set_fileset_file_attribute verbosity_pkg.sv        COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_verbosity_pkg
   set_fileset_file_attribute avalon_mm_pkg.sv        COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_avalon_mm_pkg
   set_fileset_file_attribute avalon_utilities_pkg.sv COMMON_SYSTEMVERILOG_PACKAGE avalon_vip_avalon_utilities_pkg
   
   add_fileset_file altera_avalon_mm_slave_bfm_vhdl_pkg.vhd VHDL path "$VHDL_DIR/altera_avalon_mm_slave_bfm_vhdl_pkg.vhd"
   add_fileset_file altera_avalon_mm_slave_bfm_vhdl.vhd VHDL path "$VHDL_DIR/altera_avalon_mm_slave_bfm_vhdl.vhd"
...
#   set_interface_property $SLAVE_INTERFACE registeredWaitrequest false
#    } else {
#   set_interface_property $SLAVE_INTERFACE registeredWaitrequest true
#    }
   ...
   # add signals related to transaction response
   ...
   # port termination for writeresponserequest and writeresponsevalid
   ...
   # port termination for transactionid, writeid and readid
